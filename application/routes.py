...
class MovieView(Resource):
    ...
    def put(self, uid):
        db.session.query(models.Movie).filter(models.Movie.id == uid).update(request.json)
        db.session.commit()

        return None, 204

    def delete(self,uid):
        db.session.query(models.Movie).filter(models.Movie.id == uid).delete()
        db.session.commit()
...
class DirectorView(Resource):
    def get(self, uid):
        director = db.session.query(models.Director).filter(models.Director.id == uid).first()
    ...
    def put(self, uid):
        db.session.query(models.Director).filter(models.Director.id == uid).update(request.json)
        db.session.commit()

        return None, 204

    def delete(self, uid):
        db.session.query(models.Director).filter(models.Director.id == uid).delete()
        db.session.commit()
...
class GenreView(Resource):
    def get(self, uid):
        genre = db.session.query(models.Genre).filter(models.Genre.id == uid).first()
    ...
    def put(self, uid):
        db.session.query(models.Genre).filter(models.Genre.id == uid).update(request.json)
        db.session.commit()

        return None, 204

    def delete(self, uid):
        db.session.query(models.Genre).filter(models.Genre.id == uid).delete()
        db.session.commit()
